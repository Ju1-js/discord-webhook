...
""" webhook_image_title = "Current Stable Diffusion URL"
        ...
        """ with gr.Tab(label="Sharing Embed"):
            with gr.Column(variant='panel'):
                ...
                with gr.Column():
                    ...
                    with gr.Column():
                        gr.Button(value=refresh_symbol, variant="primary").click(fn=generate_html, outputs=[_output])
            _webhook_image_content.change(fn=save_content, inputs=[_webhook_image_content], outputs=[_output])
            _webhook_image_title.change(fn=save_title, inputs=[_webhook_image_title], outputs=[_output])
            _webhook_image_description.change(fn=save_desciption, inputs=[_webhook_image_description], outputs=[_output])
            _webhook_image_footer.change(fn=save_footer, inputs=[_webhook_image_footer], outputs=[_output])
            _webhook_image_avatar_name.change(fn=save_avatar_name, inputs=[_webhook_image_avatar_name], outputs=[_output])
            _webhook_image_avatar_url.change(fn=save_avatar_url, inputs=[_webhook_image_avatar_url], outputs=[_output])
            _webhook_image_color.change(fn=save_color, inputs=[_webhook_image_color], outputs=[_output]) """
